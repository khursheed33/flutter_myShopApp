...
class _AuthCardState extends State<AuthCard>
  ...
  void initState() {
    ...
    _slideAnimation = Tween<Offset>(begin: Offset(0, -0.8), end: Offset(0, 0))
        .animate(
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (error.toString().contains("WEAK_PASSWORD")) {
        errorMessage = "Password is too weak. It must be 6+ characters";
      }
      if (error.toString().contains("INVALID_PASSWORD")) {
        errorMessage = "Password is invalid. enter correct password";
      }
